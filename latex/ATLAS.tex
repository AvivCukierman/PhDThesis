...
Tau leptons decay hadronically about 65\% of the time, in which case they are reconstructed as small-$R$ jets (\textit{tau-jets})\footnote{Taus decay to electrons or muons (+neutrinos) about 17\% of the time each. Those cases are almost indistinguishable from prompt production of the (lighter) leptons, as the only other produced particles are neutrinos. This Section focuses on fully hadronic decays.}.
