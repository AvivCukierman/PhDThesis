...
\begin{figure}[htbp]
  \centering 
  \subfloat[]{\includegraphics[width=0.5\textwidth]{figures/{smallR_calibration}.png}}
...
There is then a sequence of corrections, called the \textit{global sequential calibration} or \textit{GSC}, to further correct the residual depdendence of the jet \pT{} on various jet quantities using information from the tracker, calorimeter, and MS.
...
\begin{figure}[htbp]
  \centering 
  \subfloat[]{\includegraphics[width=0.5\textwidth]{figures/{largeR_calibration}.png}}
