...
Tau leptons decay hadronically about 65\% of the time, in which case they are reconstructed as jets (\textit{$\tau$-jets})\footnote{Taus decay to electrons or muons (+neutrinos) about 17\% of the time each; in those cases the (lighter) leptons are used to identify the $\tau$. This Section focuses on fully hadronic decays.}.
