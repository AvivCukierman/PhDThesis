...
Since there are only two features being used in this search, it may seem like overkill to use a NN, as opposed to simply examining the likelihood ratio by using two-dimensional histograms.
