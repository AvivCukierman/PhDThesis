...
%-------------------------------------------------------------------------------
Fitting and limits.
Computing resources: Appendix~\ref{app:CWoLa:computing}.

Importance of mass calibration (Chapter~\ref{ch:NI} and Chapter~\ref{ch:GenNI}).

More features.
Decorrelation (Section~\ref{sec:CWoLa:decorrelation}) and systematics (Section~\ref{sec:CWoLa:systs}).

Application to search in Chapter~\ref{ch:HBSM} (Appendix~\ref{sec:HBSM_app:lowmass}).

Alternates to CWoLa hunting: Appendix~\ref{app:CWoLa:alternatives}.
