...
The four original free parameters $m,\lambda,g,g'$ are therefore related to experimentally observable quantities~\cite{PDG}: $\alpha_e = \frac{e^2}{4\pi} = \frac{1}{137}$ is the fine structure constant; $m_Z = 91.2~\GeV$; $m_W = 80.4~\GeV$; and $m_h = 125~\GeV$.
...
This implies that in QCD the coupling strength gets weaker at higher energies, and stronger at lower energies, a phenomenon known as \textit{asymptotic freedom}\footnote{The couplings for the electroweak theory, $g$ and $g'$, also run but much less, and stay perturbative at all energy scales.}~\cite{Gross:1973id,Politzer:1973fx,Gross:1974fm}.
...
Because of the increasing strength of the strong force at low energies, quarks and gluons are \textit{confined}~\cite{Wilson:1974sk} into color-neutral composite particles, or \textit{hadrons}.
...
This collimated hadronic shower leads to \textit{jets}~\cite{Drell:1969wb,Politzer:1973fx,Blankenbecler:1972cd,Ali:2010tw} observed in the detector (Chapter~\ref{ch:Jets}).
...
When protons collide in the LHC (Chapter~\ref{ch:LHC}), the energy scales are high enough such that the individual constituent quarks and gluons do interact rather than the entire hadron~\cite{Feynman:1989dd}.
...
%Dark matter | WIMPs
A significant phenomenon unexplained by the SM is existence of \textit{dark matter}~\cite{Trimble:1987ee,Bertone:2010zza,darkmatter}.
