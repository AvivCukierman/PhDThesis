...
The strong force is unique in that, due to the strengthening of the coupling constant at low energy scales, quarks \textit{confine} into multi-quark \textit{hadrons} like protons and neutrons.
However, the strong force gets weaker at higher energy scales, a phenomenon called \textit{asymptotic freedom}.
...
This information is contained in the \textit{parton distribution function}~\cite{Amoroso:2020lgh,DelDebbio:2018siw}, or \textit{PDF}, $f_q(x,\mu^2)$, which is the probability distribution function for a parton $q$ to be carrying momentum fraction $x$ at energy scale $\mu$.
