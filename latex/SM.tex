...
In order to pull apart two quarks that compose a hadron, the larger the distance between them the greater the strength of the interaction (low energies correspond to large distances), and it becomes energy favorable to pull quark-antiquark pairs out of the vacuum to create new hadrons, a process called \textit{hadronization}.
...
A summary of the SM (after electroweak symmetry breaking) can be seen in Figure~\ref{fig:SM:SM_summary}.
\begin{figure}[htbp]
  \centering 
  ...
  \caption{Summary of SM. (a) Particle content. (b) Interactions. Figures sourced from~\cite{SM_wiki}.}
