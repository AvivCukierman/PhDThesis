...
Some proposed new theories include \textit{Supersymmetry}\cite{ref:TODO}, \textit{Higgs multiplet} models\cite{ref:TODO}, and other more exotic theories\cite{ref:TODO}.
...
Three following chapters discuss work to improve the reconstruction of the energy of jets from the measurements in the ATLAS calorimeter and tracking systems.
Chapter~\ref{ch:Voronoi} proposes a novel method for subtracting the contribution of multiple simultaneous or out-of-time proton-proton collisions, or \textit{pile-up}, to the jet energy.
