...
In these events the jets labeled the ``VBF jets'' in fact come from pile-up, underlying event, or initial or final state radiation. 
...
%                          $9^{+4}_{-4}$          & $35^{+10}_{-13}$ & $50^{+16}_{-16}$ & $230^{+50}_{-60}$ \\
              20 & $4.1\pm1.6$           & $14\pm5$           & $27\pm13$          & $60\pm17$           \\
              30 & $6.9\pm2.1$           & $31\pm9$           & $55\pm18$          & $260^{+60}_{-80}$ \\
              40 & $8.6\pm3.4$           & $30\pm9$           & $68^{+14}_{-19}$ & $250\pm60$          \\
              50 & $10.1\pm2.8$           & $44\pm14$          & $42^{+18}_{-10}$ & $230^{+60}_{-70}$ \\
              60 & $9\pm4$           & $34\pm11$          & $50\pm16$          & $230\pm60$          \\
              \hline
            \end{tabular}
            \egroup
          }
...
Assuming the two observables used to define the A/B/C/D regions are independent in the background distribution,
...
\begin{figure}[htbp]
  \centering 
  \subfloat[]{\includegraphics[width=0.33\textwidth]{figures/{ABCD_bars_val_VBF8_m20_a20_ggyy_8.7.17}.pdf}}
  \subfloat[]{\includegraphics[width=0.33\textwidth]{figures/{ABCD_bars_val_VBF8_m30_a30_ggyy_8.7.17}.pdf}}
  \subfloat[]{\includegraphics[width=0.33\textwidth]{figures/{ABCD_bars_val_VBF8_m40_a40_ggyy_8.7.17}.pdf}}\\
  \subfloat[]{\includegraphics[width=0.33\textwidth]{figures/{ABCD_bars_val_VBF8_m50_a50_ggyy_8.7.17}.pdf}}
  \subfloat[]{\includegraphics[width=0.33\textwidth]{figures/{ABCD_bars_val_VBF8_m60_a60_ggyy_8.7.17}.pdf}}
  \caption{
  %Number of events in data and signal MC (with (top row) $m_a=20$ GeV; (second row) $m_a=30$ GeV; (third row) $m_a=40$ GeV; (fourth row) $m_a=50$ GeV; (fifth row) $m_a=60$ GeV) in each region of the ABCD method.
  Number of events in data and signal MC in each region of the ABCD method, in the validation region.
  The analysis regimes are (a-e) 1-5.
  The data prediction assumes closure (\ref{eqn:HBSM:closure}) in the background in the absence of signal.
  The signal is normalized to a branching ratio BR($H\rightarrow aa \rightarrow \gamma\gamma jj)=0.03$.
  ...
  \label{fig:HBSM:ABCD_bars_val}
\end{figure}

\begin{figure}[htbp]
  \centering 
  \subfloat[]{\includegraphics[width=0.33\textwidth]{figures/{ABCD_bars_sig_VBF8_m20_a20_ggyy_8.7.17}.pdf}}
  \subfloat[]{\includegraphics[width=0.33\textwidth]{figures/{ABCD_bars_sig_VBF8_m30_a30_ggyy_8.7.17}.pdf}}
  \subfloat[]{\includegraphics[width=0.33\textwidth]{figures/{ABCD_bars_sig_VBF8_m40_a40_ggyy_8.7.17}.pdf}}\\
  \subfloat[]{\includegraphics[width=0.33\textwidth]{figures/{ABCD_bars_sig_VBF8_m50_a50_ggyy_8.7.17}.pdf}}
  \subfloat[]{\includegraphics[width=0.33\textwidth]{figures/{ABCD_bars_sig_VBF8_m60_a60_ggyy_8.7.17}.pdf}}
  \caption{
  Number of events in data and signal MC in each region of the ABCD method, in the signal region.
  The analysis regimes are (a-e) 1-5.
  The data prediction assumes closure (\ref{eqn:HBSM:closure}) in the background in the absence of signal.
  The signal is normalized to a branching ratio BR($H\rightarrow aa \rightarrow \gamma\gamma jj)=0.03$.
  The errors shown are statistical.
...
in the different regions slightly differs from the direct estimation from Equation~(\ref{eqn:HBSM:closure}).
...
%Appendix~\ref{ch:Voronoi} presents work on novel jet reconstruction algorithms which aim to reduce the effect of pile-up on the jet reconstructed energy~\cite{ATLAS-CONF-2017-065}.
